    ...
    >
      ...
      {userScroll && (
        <div
          ...
          onClick={scrollDown}
        >
          <div className="w-10 h-10 text-primary bg-white rounded-full transition-all justify-center items-center border cursor-pointer flex hover:scale-110  mx-auto">
            <ArrowDown />
          </div>
        </div>
      )}
